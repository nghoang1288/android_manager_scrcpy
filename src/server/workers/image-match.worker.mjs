...
function decodePngSource(source) {
...
function pixelDiffRGB(a, b, ai, bi) {
...
function findBestTemplateMatch(screenshot, template, region, mode = "precise") {
...
function runImageMatch(payload) {
    const {
        screenshot,
        template,
        threshold = 0.9,
...
if (workerData) {
    try {
        ...
        postSuccess(id, runImageMatch(payload));
    } catch (error) {
